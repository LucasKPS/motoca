        ...
        <div className="lg:col-span-1 flex flex-col gap-8">
            <Card>
                <CardHeader className="items-center text-center">
                    ...
                    <CardTitle className="font-headline">João da Silva</CardTitle>
                    <CardDescription>entregador@rotaexpressa.com</CardDescription>
                </CardHeader>
        ...
        <div className="lg:col-span-2">
            ...
            <CardContent className="space-y-6">
                ...
                <div className="space-y-4 pt-4">
                 ...
                 <Button className="w-full lg:w-auto">Salvar Alterações</Button>
            </CardContent>
            </Card>
        </div>
      </div>
