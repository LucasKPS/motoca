...
function SignupForm({ role }: { role: 'client' | 'merchant' | 'courier' }) {
    if (role === 'merchant') {
        return (
            <CardContent className="space-y-4 pt-6">
                <div className="space-y-2">
                    <Label htmlFor="restaurant-name">Nome do Restaurante</Label>
                    <Input id="restaurant-name" placeholder="Pizzaria Delícia" required />
                </div>
                <div className="space-y-2">
                ...
                <div className="space-y-2">
                    ...
                    <Input id="email-merchant" type="email" placeholder="contato@pizzaria.com" required />
                </div>
                 <div className="space-y-2">
                    <Label htmlFor="password-merchant">Senha</Label>
                    <Input id="password-merchant" type="password" required />
                </div>
            </CardContent>
        )
    }
        ...
        return (
            <CardContent className="space-y-4 pt-6">
                <div className="space-y-2">
                    ...
                    <Input id="name-courier" placeholder="Seu nome" required />
                </div>
                <div className="space-y-2">
                    <Label htmlFor="phone-courier">Celular com DDD</Label>
                    <Input id="phone-courier" type="tel" placeholder="(11) 99999-9999" required />
                </div>
                <div className="space-y-2">
                    <Label htmlFor="email-courier">E-mail</Label>
                    <Input id="email-courier" type="email" placeholder="seu@email.com" required />
                </div>
                 <div className="space-y-2">
                    <Label htmlFor="password-courier">Senha</Label>
                    <Input id="password-courier" type="password" required />
                </div>
            </CardContent>
        )
    }
    ...
    return (
        <CardContent className="space-y-4 pt-6">
            <div className="space-y-2">
                ...
                <Input id="name-client" placeholder="Seu nome" required />
            </div>
            <div className="space-y-2">
                <Label htmlFor="email-client">E-mail</Label>
                <Input id="email-client" type="email" placeholder="seu@email.com" required />
            </div>
            <div className="space-y-2">
                <Label htmlFor="password-client">Senha</Label>
                <Input id="password-client" type="password" required />
            </div>
        </CardContent>
    );
}
